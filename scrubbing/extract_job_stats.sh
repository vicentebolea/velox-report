...
SPECULATIVE=$(grep -Po 'SPECULATIVE \K\w*' $INFO_FILE)
MIN_BLOCK_SIZE=$(grep -Po 'MIN_BLOCK_SIZE \K\w*' $INFO_FILE)

ZERO_IO=NO

echo $JOB_NAME,$JOB_EXEC_TIME,$BLOCK_SIZE,$DFS,$SPECULATIVE,$ZERO_IO,$ALPHA,$MIN_BLOCK_SIZE
